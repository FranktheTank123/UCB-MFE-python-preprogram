...
def preping_data(data_location) -> 'tuple[pd.DataFrame, pd.Series]':
    ...
    # data_location = 'sqlite:////Users/cathy/Desktop/bkl/python/UCB-MFE-python-preprogram/Homeworks/HW9/Ziling Zhang/data/data.db'
...
def main(data_path, model_path):
    ...
    # pickle.dump(best_model, open('/Users/cathy/Desktop/bkl/python/UCB-MFE-python-preprogram/Homeworks/HW9/Ziling Zhang/data/trained_model.pckl', 'wb'))
