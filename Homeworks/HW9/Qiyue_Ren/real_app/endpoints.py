...
def creat_app():
    ...
    app.model = pickle.load(
        open(
            "/mnt/d/UCB-MFE-python-preprogram/Homeworks/HW9/Qiyue_Ren/data/trained_model.pckl",
            "rb",
        )
    )
    ...
    app.data, _ = preping_data(
        "sqlite:////mnt/d/UCB-MFE-python-preprogram/Homeworks/HW9/Qiyue_Ren/data/data.db"
    )
